    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"
                style="background-color: #342a4a !important;">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if (auth()->user()->hasRole('super_admin'))
                        ...
                        @if (auth()->user()->hasRole('super_admin') ||
                            ...
                            <li class="menu-item ">
                              <a href="javascript:void(0);" class="menu-link menu-toggle">
                                ...
                                <div >ادارة اقسام الخدمات</div>
                              </a>
                              <ul class="menu-sub px-3">
                                <li class="menu-item ">
                                  <a href="{{ route('Categories') }}" class="menu-link">
                                    <div>الاقسام الرئيسية</div>
                                  </a>
                                </li>
                              </ul>
                            </li>
                        ...
                        @if (auth()->user()->hasRole('super_admin') ||
                            auth()->user()->isAbleTo('all_dashboard') ||
                            auth()->user()->isAbleTo('manage_location'))
                            <li class="menu-item">
                                <a href="{{ route('countries') }}" class="menu-link">
                                    <i class='menu-icon tf-icons bx bx-map'></i>
                                    <div>ادارة نقاط الخدمة</div>
                                </a>
                            </li>
                        @endif
                        @if (auth()->user()->hasRole('super_admin') ||
                            ...
                            <li class="menu-item">
                                <a href="{{ route('sociaMedia') }}" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('rate') }}" class="menu-link">
                                    ...
                                    <div>ادارة العملات</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('jobs') }}" class="menu-link">
                                    <i class='menu-icon tf-icons bx bx-layout'></i>
                                    <div>ادارة الوظائف</div>
                                </a>
                            </li>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper"
                    style="background-image: url({{ asset('images/header-bg.png') }});background-repeat-y: no-repeat;">
