...
@section('content')
    ...
    @if ($do == 'Manage')
                                                ...
                                                <form id="" class="row g-3"
                                                    ...
                                                    <div class="col-12 text-center">
                                                        <button type="mit" id="mit"
                                                            class="btn btn-primary me-sm-3 me-1 mt-3 activeNews">تغيير
                                                            الحالة</button>
                                                        <button type="reset"
                                        ...
                                        <div class="modal-content p-3 p-md-5">
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('deleteNews', $news->id) }}"
                                                    ...
                                                    <div class="col-12 text-center">
                                                        <button type="mit" id="mit"
                                                            class="btn btn-primary me-sm-3 me-1 mt-3 deleteNews">حذف
                                                            الصنف</button>
                                                        <button type="reset"
                                                            class="btn btn-label-secondary btn-reset mt-3"
                                                            data-bs-dismiss="modal" aria-label="Close">Cancel</button>
        ...
        @elseif($do == 'Add')
            ...
            <div class="col-md-12 m-auto">
                <div class="card mb-4 p-4 ">
                    <h1 class="text-start fs-3 ">اضافة معلومه الحدث</h1>
                        ...
                        <form class="row g-3" action="{{ route('addNews') }}" method="POST"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="titleAr" class="form-control  name ar"
                                    id="addnewsNameAr" placeholder="اضف  الحدث" value="{{ old('nameAr') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="titleEn" class="form-control  " id="addnewsNameEn"
                                    value="{{ old('titleEn') }}" placeholder="اضف  الحدث"
                                    aria-describedby="defaultFormControlHelp" />
                                @error('titleEn')
                                    <span class="help-block text-danger">* {{ $message }} </span>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="image"
                                    ...
                                    class="form-control  " id="addnewsPhone" placeholder="اضف صورة الحدث"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="background_image"
                                    ...
                                    class="form-control " placeholder="اضف  صورة خلفيه الحدث"
                            ...
                            <div class="col-12 text-center">
                                <button type="mit" class="btn btn-primary me-sm-3 me-1 mt-3 addnews">
                                    اضافة الحدث</button>
        ...
        @elseif($do == 'Edit')
            ...
            <div class="col-md-12 m-auto">
                <div class="card mb-4 p-4 ">
                    <h1 class="text-start fs-3 ">تعديل معلومات الحدث</h1>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        @foreach ($news as $news)
                            @if ($newsId == $news->id)
                                <form class="row g-3" action="{{ route('editNews', $news->id) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="titleAr" class="form-control"
                                            ...
                                            placeholder="اضف  الحدث" aria-describedby="defaultFormControlHelp" />
                                        @error('titleAr')
                                            <span class="help-block text-danger">* {{ $message }} </span>
                                        @enderror
                                    </div>
