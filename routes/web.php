...
Route::group([
    ...
    Route::get('/services_page/{id}', [ServicesPageController::class, 'showServicesPage'])->name('services_page');
    ...
    Route::get('/managers', [ManagersPageController::class, 'showManagersPage'])->name('managers');
    Route::get('/contact_page', [ContactUsPageController::class, 'showContactUsPage'])->name('contact_page');
    Route::get('/location_page', [LocationController::class, 'showLocationPage'])->name('location_page');
});
