...
@section('content')
    ...
    <div class="card p-3">
        <h2 name="tableName " class="mb-5"> اداره المستخدمين</h2>
        <x-table>
                    ...
                    <x-slot name="tableBody" id="tbody">
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td>
                                    <a class="btn text-white " style="background-color: #8170a4" data-bs-toggle="modal"
                            ...
                            <div class="modal fade" id="editPermission{{ $user->id }}" tabindex="-1"
                                aria-hidden="true">
                            ...
                            <!-- Active user Modal -->
                            <div class="modal fade " id="activeuser{{ $user->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
                                    <div class="modal-content p-3 p-md-5">
                                        <div class="modal-body">
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            ...
                                            <form id="" class="row g-3"
                                                ...
                                                <div class="col-12 text-center">
                                                    <button type="mit" id="mit"
                                                        class="btn  me-sm-3 me-1 mt-3 activeuser color">تغيير
                                                        الحالة</button>
                                                    <button type="reset" class="btn btn-label-secondary btn-reset mt-3"
                                                        data-bs-dismiss="modal" aria-label="Close">الغاء</button>
                                                </div>
                                    ...
                                    <div class="modal-content p-3 p-md-5">
                                        <div class="modal-body">
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                            <div class="text-center mb-4">
                                                <h4 class="modal-title mb-3" id="userCrudModal">هل انت متاكد انك تريد حذف
                                                    المستخدم</h4>
                                                <p class="m-2 fs-6">في حال الموافقه سوف يتم حذف المستخدم بشكل نهائي ولن تستطيع التراجع </p>
                                            </div>
                                            <form action="{{ route('deleteUser', $user->id) }}" class="row g-3"
                                                method="GET" enctype="multipart/form-data">
                                                <input type="hidden" value="{{ $user->id }}">
                                                <div class="col-12 text-center">
                                                    <button type="mit" id="mit"
                                                        class="btn  me-sm-3 me-1 mt-3 deleteuser color">حذف
                                                        المستخدم</button>
                                                    <button type="reset" class="btn btn-label-secondary btn-reset mt-3"
                                                        data-bs-dismiss="modal" aria-label="Close">الغاء</button>
                                                </div>
